...
@Component({
  selector: "app-project-commit-new",
  templateUrl: "commit-new.component.html"
})
export class CommitNewComponent implements OnInit {
  ...
  onSubmit() { 
    ...
    this.commitService.newCommit(this.commitForm).subscribe(
      (data: any) => {
        console.log(data);
      },
      (error) => {
