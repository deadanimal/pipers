...
@Component({
  selector: "app-project-wireframe-new",
  templateUrl: "wireframe-new.component.html"
})
export class WireframeNewComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.wireframeService.newWireframe(this.wireframeForm).subscribe(
      (data: any) => {
        console.log(data);
      },
      (error) => {
      ...
      () => {
        this.router.navigateByUrl('/developments/wireframe')
      }
    )        
  }
