...
export class UserComponent implements OnInit {
  ...
  moveTo(link) {
    ...
    if (link == 'new') {
      this.router.navigateByUrl('/managements/user/new')
    } else {

      this.userService.user = this.userService.users.find(element => element.id == link)

      let url_string = '/managements/user/' + link
